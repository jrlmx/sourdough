...
<div x-data class="space-y-6">
    <flux:button variant="danger" type="button" @click="$wire.show_confirmation = true" class="w-full">
        Delete Account
    </flux:button>
    ...
    <flux:modal wire:model="show_confirmation" name="confirm" class="space-y-6">
        ...
        <form wire:submit="delete" class="space-y-6">
            <flux:input type="password" label="Password" wire:model="current_password" placeholder="Password" required
                autofocus />

            <div class="flex gap-2">
                <flux:spacer />
                <flux:button type="button" @click="$wire.show_confirmation = false">
                    Cancel
                </flux:button>
